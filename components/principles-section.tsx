  ...
  const mvps = [
    {
      ...
      description: "Driver On-Duty toggle • GPS sharing only during active trips • Privacy-first design ensures no tracking when off-duty",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: "LIVE STATUS", highlight: true },
        { text: " & ETA", highlight: false },
      ],
      description: "Real-time bus status (On Time / Delayed) • Dynamic ETA calculation for every stop based on live location",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: " MAP", highlight: false },
      ],
      description: "Interactive route map with ordered stops • Live bus position indicator • Route selection for passengers",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: " ALERTS", highlight: false },
      ],
      description: "Save favorite stops • Receive notifications when bus is 5 minutes away • Historical delay insights",
      align: "right",
    },
    {
      number: "05",
      titleParts: [
        ...
        { text: "SAFEGUARDS", highlight: true },
        { text: " & PRIVACY", highlight: false },
      ],
      description: "Tracking tied to 'On-Duty' status • Missed trip detection • Passenger reporting for untracked buses",
      align: "left",
    },
  ]
